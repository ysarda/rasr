...
# Notes:
#
#  -- For testing experimental classifier
#----------------------------------------------------

#SBATCH -J exp_classifier           # Job name
#SBATCH -o exp_classifier.o%j       # Name of stdout output file
#SBATCH -e exp_classifier.e%j       # Name of stderr error file
