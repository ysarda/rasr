...
if __name__ == "__main__":
    ...
    # create archive
    folders = [
        "/work/07965/clans/ls6/Spring_RASR/rasr/archive/",
        "/work/07965/clans/ls6/Spring_RASR/rasr/archive/" + today.strftime("%m:%d:%Y"),
        "/work/07965/clans/ls6/Spring_RASR/rasr/" + today.strftime("%m:%d:%Y"),
    ]
    for folder in folders:
        make_dir(folder)

    # get falls
    fall_files = get_list_of_files("/work/07965/clans/ls6/Spring_RASR/rasr/test/falls/")

    # get vis
    vis_files = get_list_of_files("/work/07965/clans/ls6/Spring_RASR/rasr/test/vis/")

    # move output to current date folder and clear output
    for file in vis_files:
        make_dir(
            "/work/07965/clans/ls6/Spring_RASR/rasr/"
